    ...
    <div class="px-4 py-5 sm:px-6 flex justify-between items-center">
        <div>
            ...
            <p class="mt-1 max-w-2xl text-sm text-gray-500">
                Total: {{ $proyectos->count() }} proyecto{{ $proyectos->count() !== 1 ? 's' : '' }}
            </p>
        </div>
        <div>
                    ...
                    @foreach($proyectos as $proyecto)
                        <tr class="hover:bg-gray-50 transition-colors">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                                <div class="text-sm text-gray-900">{{ $proyecto->fecha_inicio_formateada }}</div>
                                <div class="text-sm text-gray-500">{{ $proyecto->fecha_creacion_relativa }}</div>
                            </td>
                                ...
                                <div class="flex justify-end space-x-2">
                                    ...
                                    <form action="{{ route('proyectos.destroy', $proyecto) }}" method="POST" class="inline">
                                        ...
                                        <button type="submit" 
                                                ...
                                                title="Eliminar"
                                                onclick="return confirm('¿Estás seguro de que quieres eliminar el proyecto &quot;{{ $proyecto->nombre }}&quot;?')">
                                            <svg class="h-5 w-5" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
